...
import com.srgpanov.dotaskillstimer.utils.RoshanState;
...
public class RoshanTimerView extends View {
    ...
    private void init() {
        ...
        deadDrawable = ContextCompat.getDrawable(getContext(), R.drawable.roshan_death);
        deadOrLiveDrawable = ContextCompat.getDrawable(getContext(), R.drawable.roshan_death_or_live);
